(() => {
    ...
    (() => {
        ...
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    if (selectItems.length) this.selectsInit(selectItems); else this.setLogging("Сплю, нет ни одного select zzZZZzZZz");
                }
            }
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".staff-slider")) new core(".staff-slider", {
        ...
        function videoPlayer() {
            let video = document.querySelector(".video-module__item");
            let progbar = document.querySelectorAll(".video-module__video-track");
            let time = document.querySelector(".video-module__timeline");
            let btnPlay = document.querySelector(".video-module__play");
            let btnRewind = document.querySelector(".video-module__rewind");
            let btnForward = document.querySelector(".video-module__forward");
            let volumeControl = document.querySelector(".video-module__volume");
            if (btnPlay) {
                let videoPlay;
                btnPlay.addEventListener("click", (function(e) {
                    ...
                    videoPlay = setInterval((function(e) {
                        ...
                        time.style.width = 100 * videoTime / videoLength + "%";
                    }), 10);
                }), false);
            }
            progbar.forEach((progbar => progbar.addEventListener("click", (function(e) {
                var x = void 0 == e.offsetX ? e.layerX : e.offsetX;
                var getvideoholder = e.currentTarget.closest(".video-module");
                var wdth = getvideoholder.querySelector(".video-module__video-track").offsetWidth;
                var viddur = getvideoholder.querySelector(".video-module__item").duration;
                getvideoholder.querySelector(".video-module__item").currentTime = x * viddur / wdth;
            }))));
            if (video) video.addEventListener("ended", (function(e) {
                video.currentTime = 0;
                video.parentElement.classList.remove("playing");
            }), false);
            ...
            if (btnRewind) btnRewind.addEventListener("click", (function(e) {
                video.currentTime -= 5;
            }));
            if (btnForward) btnForward.addEventListener("click", (function(e) {
                video.currentTime += 5;
            }));
        }
        videoPlayer();
